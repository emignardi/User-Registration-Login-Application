...
<body>
	...
	<script type="text/javascript">
		...
		if (status == "Success") {
			...
			swal("Sorry", "Invalid Confirm Password", "error");
		}
		else if (status == "Invalid Phone Number") {
			swal("Sorry", "Invalid Phone Number", "error");
		}
		else if (status == "Invalid Phone Number Length") {
			swal("Sorry", "Invalid Phone Number Length", "error");
		}
	</script>
